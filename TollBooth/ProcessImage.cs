// Default URL for triggering event grid function in the local environment. http://localhost:7071/runtime/webhooks/EventGrid?functionName={functionname}

// Learn how to locally debug an Event Grid-triggered function: https://aka.ms/AA30pjh

// Use for local testing: https://{ID}.ngrok.io/runtime/webhooks/EventGrid?functionName=ProcessImage
...
namespace TollBooth
{
    public static class ProcessImage
    {
            ...
            ILogger log)
        {
            ...
            // Reuse the HttpClient across calls as much as possible so as not to exhaust all
            // available sockets on the server on which it runs.
